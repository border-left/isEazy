        ...
        try {
            ...
            if(!$shopProduct) {
                return response()->json([
                    'message' => "Product $productInfo not available for store $shopInfo"
                ]);
            }
            ...
            return response()->json([
                'message' => "You have purchased $quantityPurchased units of product $productInfo in store $shopInfo",
